...
import java.net.URL;
public class TestcaseSaucedemo1Test {
  ...
  @Test
  public void testcaseSaucedemo1() {
    ...
    driver.findElement(By.cssSelector(".back-image")).click();
    ...
    driver.findElement(By.cssSelector("*[data-test=\"password\"]")).sendKeys("secret_sauce");
    driver.findElement(By.cssSelector("*[data-test=\"login-button\"]")).click();
    driver.findElement(By.cssSelector(".bm-icon")).click();
